...
class DeepQNetwork:
    ...
    def __init__(
        ...
        if output_graph:
            tf.summary.FiltWriter("logs/", self.sess.graph)
    ...
    def learn(self):
        ...
        self.epsion = self.epsilon + self.epsilon_increment if self.epsilon < self.epsilon_max else self.epsilon_max
        self.learn_step_counter += 1

    def plot_cost(self):
        import matplotlib.pyplot as plt

        x = np.arange(len(self.cost_his))
        y = self.cost_his
